...
const AboutPage = () => {
  ...
  return (
		<>
			<article className="fadeIn aboutArticle">
				...
				<TextBlock padBottom='3em' padTop='0em' narrow>
					<p>While front-end is my specialty, I&rsquo;m comfortable working across the stack when needed. Much of my career was spent in agency environments, building client projects end-to-end. Early on, that meant creating immersive Flash experiences, followed by years of CMS-driven development on the LAMP stack, including ExpressionEngine, CraftCMS, and custom PHP solutions. More recently, I led the evolution of a large Shopify storefront from traditional Liquid templates to a modern React, Next.js, and headless CMS architecture. Today, that stack, paired with Vercel, is my preferred approach.</p>
