		...
		<div className={styles.container}>
			<div className={styles.buckets}>
				...
				<div className={styles.bucket}>
					<TransitionLink href="/services#adhd-autism-therapy" className={styles.image}>
						<Image
							src={adhdImage}
					...
					<div className={styles.content}>
						...
						<p><TransitionLink className={styles.link} href="/services#adhd-autism-therapy">ADHD &amp; Autism Therapy <span>&rarr;</span></TransitionLink></p>
					</div>
				</div>

				<div className={styles.bucket}>
					<TransitionLink href="/services#trauma-therapy" className={styles.image}>
						<Image
							src={traumaImage}
					...
					<div className={styles.content}>
						...
						<p><TransitionLink className={styles.link} href="/services#trauma-therapy">Trauma Therapy <span>&rarr;</span></TransitionLink></p>
					</div>
				</div>		

				<div className={styles.bucket}>
					<TransitionLink href="/services#attachment-relationship-work" className={styles.image}>
						<Image
					...
					<div className={styles.content}>
						...
						<p><TransitionLink className={styles.link} href="/services#attachment-relationship-work">Attachment &amp; Relationship Work <span>&rarr;</span></TransitionLink></p>
					</div>
				</div>

				<div className={styles.bucket}>
					<TransitionLink href="/services#burnout-life-transitions" className={styles.image}>
						<Image
							src={burnoutImage}
					...
					<div className={styles.content}>
						...
						<p><TransitionLink className={styles.link} href="/services#burnout-life-transitions">Burnout &amp; Life Transitions <span>&rarr;</span></TransitionLink></p>
					</div>	
				</div>

				<div className={styles.bucket}>
					<TransitionLink href="/services#faith-transitions-religious-trauma" className={styles.image}>
						<Image
							src={religionImage}
					...
					<div className={styles.content}>
						...
						<p><TransitionLink className={styles.link} href="/services#faith-transitions-religious-trauma">Faith Transitions &amp; Religious Trauma <span>&rarr;</span></TransitionLink></p>
					</div>	
				</div>
