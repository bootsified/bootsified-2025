...
import { PrismaClient, ProjectType, MediaType } from '@prisma/client'
...
// Projects data (converted from data.tsx, with Asset objects converted to strings)
const projectsData = [
  {
    slug: 'vickery',
  ...
  },
  {
    ...
    url: '',
    media: '/videos/mizzen-walkthrough-web.mp4',
  ...
  },
  {
    ...
    url: '',
    media: '/videos/adopted-walkthrough-web.mp4',
    mediaType: 'walkthrough',
  ...
  },
  {
    ...
    url: '',
    media: '/videos/thelaurel-walkthrough-web.mp4',
    mediaType: 'walkthrough',
    skills: ['HTML', 'CSS', 'JS', 'CraftCMS', 'Twig'],
    notes:
  ...
  },
  {
    ...
    url: '',
    media: '/videos/falchi-walkthrough-web.mp4',
    mediaType: 'walkthrough',
    skills: ['HTML', 'CSS', 'JS', 'CraftCMS', 'Twig'],
    notes:
  ...
  },
  {
    ...
    url: '',
    media: '/videos/hinge-walkthrough-web.mp4',
    mediaType: 'walkthrough',
    skills: ['HTML', 'CSS', 'JS', 'ExpressionEngine'],
    notes:
  ...
  },
  {
    ...
    url: '',
    media: '/videos/pregnancyhotline-walkthrough-web.mp4',
    mediaType: 'walkthrough',
    skills: ['HTML', 'CSS', 'JS', 'ExpressionEngine'],
    notes:
  ...
  },
  {
    ...
    url: '',
    media: '/videos/doubler-walkthrough-web.mp4',
    mediaType: 'walkthrough',
    skills: ['HTML', 'CSS', 'JS', 'Liquid', 'Custom Shopify Themeing'],
    notes:
...
async function main() {
  ...
  for (let i = 0; i < projectsData.length; i++) {
    ...
    const categories = await prisma.category.findMany({
      where: { slug: { in: projectData.categories } },
    })
    
    const skills = await prisma.skill.findMany({
      where: { name: { in: projectData.skills } },
    })
    ...
    await prisma.project.upsert({
      ...
      create: {
        ...
        projectType: projectTypeMap[projectData.projectType],
        agency: projectData.agency,
        logo: projectData.logo,
        screenshotNoir: projectData.screenshotNoir,
        screenshot: projectData.screenshot,
        url: projectData.url,
        media: projectData.media,
        mediaType: mediaTypeMap[projectData.mediaType],
