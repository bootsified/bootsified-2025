  ...
  return (
    <div className={styles.overlay}>
      <div className={styles.modal}>
        ...
        <p>
          The link you are about to visit is a <strong>static recreation</strong> of the original {projectTitle} website, created for portfolio purposes only. Some features or functionality may not work as expected.
        </p>
